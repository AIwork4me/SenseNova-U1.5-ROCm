...
Generated by `scripts/validate.sh` on the reference host (gfx1100, full-stack ROCm 7.14 mode). Full-resolution originals live in `outputs/validation/` (not committed); each preview links to its receipt in `docs/results/validation/`.
